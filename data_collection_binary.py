...
#testing data
count = len(os.listdir("E:\Sign-Language-To-Text-and-Speech-Conversion-master\AtoZ_3.1\A"))
...
while True:
    try:
        ...
        if interrupt & 0xFF == ord('n'):
            ...
            # test data
            count = len(os.listdir("E:\Sign-Language-To-Text-and-Speech-Conversion-master/test_data_2.0/Gray_imgs//" + p_dir + "//"))
        ...
        if flag==True:
            ...
            if step%2==0:
                ...
                cv2.imwrite("D:\\test_data_2.0\\Gray_imgs\\" + p_dir + "\\" + c_dir + str(count) + ".jpg",
                            img_final1)
                cv2.imwrite("D:\\test_data_2.0\\Gray_imgs_with_drawing\\" + p_dir + "\\" + c_dir + str(count) + ".jpg",
                    img_final2)
